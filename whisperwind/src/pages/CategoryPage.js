    ...
    const fetchAudioFiles = async () => {
      ...
      try {
        ...
        const audioFiles = {
          ...
          'Crackling Fire': [
            { title: 'Crackling Fire Audio 1', imageUrl: cracklingFireImage, audioUrl: 'https://cdn.pixabay.com/download/audio/2022/01/18/audio_2c362dfa75.mp3?filename=aachen_burning-fireplace-crackling-fire-soundswav-14561.mp3' },
            { title: 'Crackling Fire Audio 2', imageUrl: cracklingFireImage, audioUrl: 'https://cdn.pixabay.com/download/audio/2022/01/18/audio_2c362dfa75.mp3?filename=aachen_burning-fireplace-crackling-fire-soundswav-14561.mp3' },
            { title: 'Crackling Fire Audio 3', imageUrl: cracklingFireImage, audioUrl: 'https://example.com/cracklingFirePlaceholder3.mp3' },
            { title: 'Crackling Fire Audio 4', imageUrl: cracklingFireImage, audioUrl: 'https://example.com/cracklingFirePlaceholder4.mp3' },
            { title: 'Crackling Fire Audio 5', imageUrl: cracklingFireImage, audioUrl: 'https://example.com/cracklingFirePlaceholder5.mp3' },
            { title: 'Crackling Fire Audio 6', imageUrl: cracklingFireImage, audioUrl: 'https://example.com/cracklingFirePlaceholder6.mp3' },
            { title: 'Crackling Fire Audio 7', imageUrl: cracklingFireImage, audioUrl: 'https://example.com/cracklingFirePlaceholder7.mp3' },
            { title: 'Crackling Fire Audio 8', imageUrl: cracklingFireImage, audioUrl: 'https://example.com/cracklingFirePlaceholder8.mp3' },
            { title: 'Crackling Fire Audio 9', imageUrl: cracklingFireImage, audioUrl: 'https://example.com/cracklingFirePlaceholder9.mp3' },
            { title: 'Crackling Fire Audio 10', imageUrl: cracklingFireImage, audioUrl: 'https://example.com/cracklingFirePlaceholder10.mp3' },
          ],
